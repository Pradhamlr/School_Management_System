...
type Props = { open: boolean; initial?: any | null; onOpenChange: (v:boolean)=>void; onSaved: ()=>void };

export default function SubjectFormModal({ open, initial, onOpenChange, onSaved }: Props){
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{initial ? 'Edit Subject' : 'Create Subject'}</DialogTitle>
        </DialogHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 p-2">
            <FormItem>
              ...
              <FormControl>
                <input className="input w-full" {...form.register('name', { required: 'Name is required' })} />
              </FormControl>
            ...
            <FormItem>
              ...
              <FormControl>
                <input className="input w-full" {...form.register('code', { required: 'Code is required' })} />
              </FormControl>
...
type Props = { initial?: any; open: boolean; onOpenChange: (v:boolean)=>void; onSaved: ()=>void };
